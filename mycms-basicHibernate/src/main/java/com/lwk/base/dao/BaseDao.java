...
import com.lwk.base.SystemContext;
...
public class BaseDao<T> implements IBaseDao<T> {
	 ...
	 * @param args
	 * @param clz
	 * @param hasEntity 如果不是一个hibernate管理的实体对象 在要用setResultTransformer查询
	 * http://blog.csdn.net/youlingqishi11/article/details/6886746
	 * 比如：
